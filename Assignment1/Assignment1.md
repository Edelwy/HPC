...
![Seam Carving versus scaling. Seam Carving better preserves the content of the image. (Source: Wikipedia)](media/seamCarving2.png)
...
![Energy of the image computed using Sobel operator. (Source: Wikipedia)](media/energy.png)
...
![Computation of cumulative energy from the bottom of the image to the top.](media/cumulative.png)
...
![Traversing the image from top to bottom and selecting pixels to be removed.](media/search.png)
...
![Computational dependency of pixel $M(i,j)$ when calculating cumulative energy.](media/triangle2.png)

![Splitting the image into strips of triangles to improve efficiency of the parallel algorithm.](media/up-down.png)
