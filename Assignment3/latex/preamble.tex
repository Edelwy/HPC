...
\renewcommand{\maketitle}{%
  \begin{center}
    {\Huge\bfseries Molecular dynamics: 2D Lennard-Jones Simulation }\\[0.5em]  % Adjust spacing here
    {\Large\bfseries Third Homework Assignment}\\[0.5em]  % Adjust spacing here
    {\large Nina Mislej \hspace{0.8em} \normalsize \today}\\[0.3em]  % The date, with NO extra space below it
  \end{center}
